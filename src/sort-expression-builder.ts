...
/**
 * Builder used to build sort expressions.
 * 
 * @type {SortExpressionBuilder}
 */
export class SortExpressionBuilder
{
    /**
     * Builds asc sort expression.
     * 
     * @param {PropertyInfoProxy<TProperty>} propertyInfoProxy Property info proxy.
     * 
     * @returns {AscSortExpression} Asc sort expression.
     */
    public asc<TProperty>(propertyInfoProxy: PropertyInfoProxy<TProperty>): AscSortExpression
    {
        return new AscSortExpression(propertyInfoProxy[proxyTargetSymbol]);
    }
