...
/**
 * Not ends with expression.
 * 
 * @type {NotEndsWithExpression}
 */
export class NotEndsWithExpression extends FilterExpression
{
    /**
    ...
    {
        return expressionVisitor.visitNotEndsWithExpression(this);
    }
}
